<section class="hero">
                            ...
                            <div id="carouselExampleCaptions" class="carousel carousel-fade hero-carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="carousel-site_image/-wrap">
                                            <img src="site_image/s/slide/jay-wennington-N_Y88TWmGwA-unsplash.jpg" class="img-fluid carousel-site_image/" alt="">
                                        </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="carousel-site_image/-wrap">
                                            <img src="site_image/s/slide/jason-leung-O67LZfeyYBk-unsplash.jpg" class="img-fluid carousel-site_image/" alt="">
                                        </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="carousel-site_image/-wrap">
                                            <img src="site_image/s/slide/ivan-torres-MQUqbmszGGM-unsplash.jpg" class="img-fluid carousel-site_image/" alt="">
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                <div class="menu-site_image/-wrap">
                                    <img src="site_image/s/breakfast/brett-jordan-8xt8-HIFqc8-unsplash.jpg" class="img-fluid menu-site_image/" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                <div class="menu-site_image/-wrap">
                                    <img src="site_image/s/lunch/farhad-ibrahimzade-MGKqxm6u2bc-unsplash.jpg" class="img-fluid menu-site_image/" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                <div class="menu-site_image/-wrap">
                                    <img src="site_image/s/dinner/keriliwi-c3mFafsFz2w-unsplash.jpg" class="img-fluid menu-site_image/" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                <div class="menu-site_image/-wrap">
                                    <img src="site_image/s/dinner/farhad-ibrahimzade-ZipYER3NLhY-unsplash.jpg" class="img-fluid menu-site_image/" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                <div class="menu-site_image/-wrap">
                                    <img src="site_image/s/breakfast/louis-hansel-dphM2U1xq0U-unsplash.jpg" class="img-fluid menu-site_image/" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                <div class="menu-site_image/-wrap">
                                    <img src="site_image/s/lunch/farhad-ibrahimzade-D5c9ZciQy_I-unsplash.jpg" class="img-fluid menu-site_image/" alt="">
            ...
            <section class="Bgsite_image/"></section>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="news-thumb mb-4">
                                <a href="news-detail.html">
                                    <img src="site_image/s/news/pablo-merchan-montes-Orz90t6o0e4-unsplash.jpg" class="img-fluid news-site_image/" alt="">
                                </a>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="news-thumb mb-4">
                                <a href="news-detail.html">
                                    <img src="site_image/s/news/stefan-johnson-xIFbDeGcy44-unsplash.jpg" class="img-fluid news-site_image/" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="news-thumb mb-lg-0 mb-lg-4 mb-0">
                                <a href="news-detail.html">
                                    <img src="site_image/s/news/gilles-lambert-S_LhjpfIdm4-unsplash.jpg" class="img-fluid news-site_image/" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="news-thumb mb-lg-0 mb-lg-4 mb-2">
                                <a href="news-detail.html">
                                    <img src="site_image/s/news/caroline-attwood-bpPTlXWTOvg-unsplash.jpg" class="img-fluid news-site_image/" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="news-thumb mb-4">
                                <a href="news-detail.html">
                                    <img src="site_image/s/news/louis-hansel-GiIiRV0FjwU-unsplash.jpg" class="img-fluid news-site_image/" alt="">
                                </a>
